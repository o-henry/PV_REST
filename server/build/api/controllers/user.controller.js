...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.find = function (user) {
        return user;
    };
    UserController.prototype.createToken = function (body, res) {
        return __awaiter(this, void 0, void 0, function () {
            var token;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, firebase_provider_1.createFBToken(body.id, body.email, body.name)];
                    case 1:
                        token = _a.sent();
                        if (token) {
    ...
    UserController.prototype.delete = function (id, res) {
        return __awaiter(this, void 0, void 0, function () {
            var del;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, firebase_provider_1.DelUser(id)];
                    case 1:
                        del = _a.sent();
                        return [2 /*return*/, res.status(200).send(del)];
                }
            });
        });
    };
